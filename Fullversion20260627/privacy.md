...
- The AI providers you configure have their own privacy policies governing how they handle data sent to their services.
...
You can configure any AI service by providing:
- API endpoint URL
- API key
- Model name
- Other optional parameters

All configuration is stored locally on your device.
...
- 您配置的 AI 提供商有自己的隐私政策，管辖他们如何处理发送至其服务的数据。
...
- 您配置的 AI 提供商有自己的隱私權政策，管轄他們如何處理傳送至其服務的資料。
