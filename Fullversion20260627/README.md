...
2. Tap **Add Provider** to configure your own AI service
3. Enter your API key, model name, and base URL
...
- **Online features**: Cloud AI providers require internet access
...
2. 点击 **添加提供商**，配置您自己的 AI 服务
3. 输入您的 API 密钥、模型名称和基础地址
4. 点击 **保存** 并测试连接
5. 将该提供商设为启用服务
...
2. 點擊 **新增提供商**，配置您自己的 AI 服務
3. 輸入您的 API 金鑰、模型名稱和基礎網址
4. 點擊 **儲存** 並測試連線
5. 將該提供商設為啟用服務
